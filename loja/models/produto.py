...
class Produto(models.Model):
    ...
    categoria = models.ForeignKey(Categoria, null=True, related_name='categoria_do_produto', on_delete=models.SET_NULL)
    fabricante = models.ForeignKey(Fabricante, null=True, related_name='fabricante_do_produto', on_delete=models.SET_NULL)
